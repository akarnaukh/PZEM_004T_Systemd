...
## Описание
PZEM-004T Monitor - это системный сервис для мониторинга электроэнергии с помощью датчиков PZEM-004T через интерфейс UART / Modbus-RTU. Сервис предназначен для работы на embedded Linux системах (Raspberry Pi, Orange Pi, Luckfox Pico и др.).
Для 3х фазного - [PZEM_6L24_Systemd](https://github.com/akarnaukh/PZEM_6L24_Systemd)
...
В каталоге [/Graph_html](https://github.com/akarnaukh/PZEM_004T_Systemd/tree/main/Graph_html) простой HTML файл для построения графика из лог файла. 
## Установка и сборка
